...
class DesemberSurveys extends ListRecords
{
    protected static string $resource = MonitoringSurveyResource::class;

    protected static ?string $title = 'Desember';
    ...
    {
        return parent::getTableQuery()->where('bulan', 'Desember');
    }
}
